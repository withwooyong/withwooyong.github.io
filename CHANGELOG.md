...
>
> 함께 실은 것이 둘 있다. 하나는 PR [#20](https://github.com/withwooyong/withwooyong.github.io/pull/20) 의 merge 커밋과 배포 run 을 인수인계에 채운 것이고,
> 다른 하나는 `CLAUDE.md` 가 자리를 비워 둔 **백슬래시 함정을 50번으로 쓴 것**이다.
