...
| 월 | 절 수 | 날짜 |
| --- | ---: | --- |
| [`2026-09`](docs/changelog/2026-09.md) | 6 | 2026-09-02 · 2026-09-02 · 2026-09-02 · 2026-09-01 · 2026-09-01 · 2026-09-01 |
...
> 원본 `pm-po/01` §7·§8·§9 8,126 B → `planning-and-product-ops` **19,008 B**.
> 설계값 19,117 대비 **−0.6%** · 밴드 17,985 ~ 20,250 **안**(상단까지 **1,242**). 역산 k 는 **2.030** 이다.
...
⇒ **예산에는 상수 2,455 를 그대로 쓰되, 「고정 비용이 상수에 수렴한다」는 문장은 취소한다.**
편3의 0.004 는 우연히 겹친 한 점이었다.
