...
| :---: | --- | ---: | ---: | ---: | ---: | ---: | --- |
| 1 | §0 + §1 (지도편) | 7,175 | 0.0 | 0.0 | — | ~~14,300~~ → ~~17,800~~ → ~~19,615~~ → ~~20,002~~ → ~~20,150~~ → ~~20,326~~ → **20,438** | **발행 확정** (§7-5-d · §7-7-j · §7-7-k) |
...
| 4 | §6 + §7 | 11,418 | 15.0 | 15.0 | **1.92** | ~~19,500~~ → **21,960** | **발행 확정** · 밴드 18,000 ~ 22,000 안(여유 40) |
| 5 | §8 | 11,658 | 8.3 | 8.3 | **1.97** | **23,000** (§7-8-c) | 20,700 ~ 25,300 (§3-1-g) |
...
| ⑥ | 🔴 **개시 틀을 물려받지 마라.** 편2·편3이 「장면 → 지도 → 목차」 3박자, 편4가 「명제 → 상속 → 대가」였다. **넷째 형태를 찾아라** |
