...
18,615는 발행 지도편 다섯(16,065 · 17,661 · 19,392 · 19,939 · 23,536) 중 **3위**다.
...
| :---: | --- | ---: | ---: | ---: | ---: | ---: | --- |
| 1 | §0 + §1 (지도편) | 7,175 | 0.0 | 0.0 | — | ~~14,300~~ → **17,800** | **실측 확정** (§3-1-f) |
...
겉보기 합계 비율 **1.90**(편1 실측 반영 전 1.85). 앞 배치(2.06)보다 낮게 잡은 것은
코드 12.6배(§2-2) 때문이다.
...
| **C-4** 비율은 원본 **성분**에 갈린다 — 표는 낮고 불릿/산문은 높다 | 표 **≈1.4** · 비표 **≈2.3** | | |
