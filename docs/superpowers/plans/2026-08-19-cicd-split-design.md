...
| :---: | --- | ---: | ---: | ---: | ---: | ---: | --- |
| 1 | §0 + §1 (지도편) | 7,175 | 0.0 | 0.0 | — | ~~14,300~~ → ~~17,800~~ → **19,341** | **발행 확정** (§3-1-f) |
...
| ③ | **`master`/`slave` 방침의 구멍을 메운다** — 원본 27줄 중 **25줄이 브랜치명**이다. 편1 방침은 「산문 vs 환경변수명·설정 키」로만 갈라 **셸 명령·YAML 값·Git Flow 고유명에 답이 없다.** 원본 341줄이 쓰는 `master(main)` 병기를 표준으로 삼는다 | 편2=3 · 편3=**9** · 편4=6 · 편5=4 · 편7=3 | 편3이 최다 부담이다 |
