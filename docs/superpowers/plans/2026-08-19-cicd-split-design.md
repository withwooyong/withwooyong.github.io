...
| 7 | §12 + §13 (Q&A) | 15,916 | 0.0 | 0.0 | — | **28,000** ⚠️ | 26,300 ~ 29,200 (§3-3) ⚠️ |
| **합계** | | **80,607** | | | | **≈ 155,100** | |
...
⚠️ **편7의 28,000 은 아직 재산정되지 않았다.** 28,000 / 15,916 = **1.759** 로
발행 4편의 실측 최소(1.925)보다도 낮다 — 편6이 1.80으로 잡혔다가 §7-9-c 에서
2.00으로 올라간 것과 **같은 병**이다. 편7 집필 전에 §7-10 에서 재산정한다.
...
⚠️ **편7(목표 28,000 · 밴드 26,300~29,200)과 천장이 겹친다.** 편7도 같은 병이 있다 —
28,000 / 15,916 = **1.759**로 실측 최소 1.925보다도 낮다. **편7 재산정은 §7-10에서 한다.**
편6 천장을 좁혀서 겹침을 푸는 것은 거꾸로다 — 두 편 다 계획값이 낮은 것이 원인이다.
...
| 원본 §9 결론부 인용(「둘 다 알아야 한다」·레거시 마이그레이션·리더 관점) | 같은 자리. 「강의」 표현 제거 후 **편7이 쓴다** |
