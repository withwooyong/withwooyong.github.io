...
`강의` 160행 중 **`강의가 ~한다`·`강의는 ~한다` 형태가 130여 개**다. 즉 **이 문서들의 서술 주체가 "강의"**다. 단어 하나 지우는 문제가 아니라 **문장의 주어를 바꾸는 문제**이고, §15-2/CR-1.10이 정확히 금지한 작업이다.
...
| 본문 26편 발행 총량 | **468.2KB** — §4-1 「×배율」 열 합. **382,562 × 1.2가 아니다**(§4-2 예외 3건) |
| sitemap 증가 | 142 → **약 180 URL** |
