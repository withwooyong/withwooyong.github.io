...
**진행**: T1(편6·7·8) `9c0b9fd` · T2(편9) `6a56f4a` · T3(편1·편4) `695cdad` · **T4(편2·편3) `37e413b`** → **현재 121편 · sitemap 184 URL · 8/11 발행**
...
| **T5** | 편5 (린 아키텍처) | **▶ 다음.** `09a` Skills 층위 판정을 T1~T4 발행본과 대조한 뒤. ⚠️ **T4가 `03 L27`의 `09` 링크를 걷었다**(당시 편5 미발행). **편5 발행 후 편2에서 그 자리를 되살릴지 판단하라** |
...
| 항목 | 기대값 |
| --- | ---: |
| 발행 편수 | **113 + 11 = 124편** — ⚠️ **T4까지 실측 121편**(8/11 발행, 3편 남음) |
| sitemap URL | ~~174 + 11 + 신규 태그 5 = **190**~~ · ~~신규 태그 0개 → **186**~~ → ⚠️⚠️ **T4에서 깨졌다. 실측 184.** **§10-3 참조 — 최종 예측 188** |
| `npm test` | 36개 통과 |
| `npx tsc --noEmit` | 0 |
| `npm run build` | 0 |
