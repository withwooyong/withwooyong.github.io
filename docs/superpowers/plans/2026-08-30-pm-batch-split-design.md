...
| 항목 | 설계값 | 실측 | 차 |
| --- | ---: | ---: | ---: |
| 발행 B | 13,969 | **14,372** | +403 (+2.9%) |
| 배정 원본 | 5,590 | 5,590 | — |
| 밴드 | 13,187 ~ 14,752 | — | **안** (상단까지 380) |
| 하한 `MIN_BYTES` 13,300 | (밴드 하단이 −113) | — | **+1,072** |
| 고정 비용 (frontmatter + 도입 + 정리) | (상수 2,455) | **2,489** (714 + 678 + 1,097) | **+34** |
| 역산 k — 상수 2,455 기준 | 2.05 | **2.122** | +0.072 |
| 역산 k — 실측 고정 비용 기준 | 2.05 | **2.116** | +0.066 |
| 표 | (≈1.30 배) | 4,183 (원본 2,647 · **1.580**) | +0.28 |
...
| **이번 B** | **3,013** | **2,489** | **−524** |

🔴 **그리고 두 역산 k 가 붙었다.** 편2는 상수 기준 2.163 대 실측 기준 2.080 으로 0.083
벌어졌는데, 편3은 2.122 대 2.116 으로 **0.006** 이다. 고정 비용이 상수에 수렴하면 두 산식이
