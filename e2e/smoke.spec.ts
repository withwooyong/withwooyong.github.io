...
test.describe("라우트", () => {
  ...
  // 2026-08-28 (T11): /work/ 를 되살렸다. 2026-08-28 (T12): /about/ 도 같은 자리로 돌아왔다.
  // 이월로 빠져 있는 라우트는 이제 하나도 없다.
  for (const path of ["/", "/blog/", "/en/", "/work/", "/about/"]) {
  ...
  // 2026-08-28 (T11): /work/ 복귀. 2026-08-28 (T12): /about/ 복귀.
  for (const path of ["/blog/", "/work/", "/about/"]) {
