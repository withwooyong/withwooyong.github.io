...
> 마지막 갱신 2026-09-17 · 🖼️ **17번 순서 ② 첫 편 — 플로우차트를 처음 SVG 로 그렸다** · 발행본 Mermaid **560** · 발행본 **193편**
>
> **이번 세션(2026-09-17, 2차) —** `main`(`82c8e7c7`)에서 브랜치 `feat/diagram-svg-agentic-coding` 을 새로 갈라, 17번 순서 ② 첫 편 `content/blog/agentic-coding/context-budget-session.md` 의 Mermaid 넷을 SVG 로 옮겼다.
>
> | 항목 | 내용 |
> | --- | --- |
