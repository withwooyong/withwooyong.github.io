...
> **이번 세션은 지역 그래프 위젯을 만들었다** — 본문 사이드바 하단에 현재 편을 중심으로
> 한 링크 그래프를 그린다. 커밋 8개가 **로컬에만 있다. 아직 푸시하지 않았다**
...
| 커밋 | 🔴 **로컬 8개 · 미푸시** — `4029095` · `69b7221` · `f943d2b` · `ed087d8` · `ce4656b` · `c6f4ba1` · `8f57400` (+ 계획서 `97a6c84`) |
| 푸시 · 배포 | ⬜ **하지 않았다.** 계획서 전역 제약이 「사용자가 명시적으로 요청할 때만」으로 못 박았다 |
