...
> 마지막 갱신 2026-09-07 · `pm-practice` 배치 **편2/8 발행** · 발행본 **186편** ·
> **리포 전체의 도식 라벨 잘림을 닫았다.**
>
...
| 검색 인덱스 | ✅ `out/blog/search-index.json` · **186편 · 헤딩 2,701개 · 315 KB** (2026-09-07 빌드 실측) |
...
| 브랜치 | `content/pm-po-domains` 다. ⚠️ **이 저장소는 워크트리를 여럿 쓴다** — 리포 루트가 다른 세션의 브랜치(`content/presentation-decks`)를 잡고 있어 이 병합은 `withwooyong.github.io-pmpo` 워크트리에서 했다. 브랜치를 갈아타기 전에 `git worktree list` 를 먼저 읽어라 |
