...
| 푸시 · 배포 | ✅ **`research/diagram-semantics` 를 푸시하고 PR [#18](https://github.com/withwooyong/withwooyong.github.io/pull/18) 을 열었다** (`origin/main` = `572a849` 에서 갈라진 선형 커밋 둘). ⏳ **merge 는 아직 하지 않았다. 사용자 승인이 필요하다** — merge 커밋과 배포 run 은 뒤이은 세션이 채운다. 아래 행이 직전 세션까지의 기록이다 |
