...
[다음 편](/blog/ai-product-planning/whether-gate/)은 여기서 만든 재료를 판정대에 올린다. 네 문서가 갖춰졌는지를 무엇으로 검사하는지, 증거의 강도를 어떤 척도로 채점하는지, 한 건당 드는 값이 어느 선을 넘으면 자동으로 막히는지, 그리고 착수와 보류 사이에 놓인 세 번째 판정이 무엇인지가 거기서 갈린다.
