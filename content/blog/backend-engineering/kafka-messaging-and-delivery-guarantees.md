...
메시지가 무사히 도착하고 나면 남는 일은 그것을 어디에 담고 어떻게 꺼내 보이느냐다. 알림은 쌓이기만 하고 지워지지 않으며, 사용자가 실제로 여는 것은 가장 최근 몇십 건뿐인데도 조회는 하루 수천만 번 일어난다. [다음 편](/blog/backend-engineering/notification-storage-and-query-performance/)은 그 비대칭 위에서 저장소를 고르고 페이징과 캐시를 설계한다.
