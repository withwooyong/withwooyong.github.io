...
| **게이트** | **둘을 다 쓴다.** Quality Gate — 기계가 수치로 판정하는 관문(편6) · 승인 게이트 — **배포 단계에서** 사람이 통과를 허가하는 자리(편1·2·6) | [사람 게이트](/blog/ai-transformation/sdlc-human-gates/) — 개발 수명주기의 **여러 지점**에서 사람이 판정을 넘겨받는 자리 |
