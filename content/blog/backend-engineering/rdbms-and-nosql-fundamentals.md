...
마지막 행의 단서가 이 표에서 가장 중요하다. **NoSQL이 나온 뒤에도 RDBMS 영역은 여전히 확고하다.** 새 선택지는 기존 선택지를 대체한 것이 아니라 기존 선택지가 못 풀던 문제를 가져간 것이고, 그래서 오늘날의 선택은 "무엇이 최신인가"가 아니라 "이 문제가 어느 쪽 것인가"가 된다. NewSQL이 2020년대에 등장한 것도 같은 맥락이다 — 트랜잭션 보장과 확장성 중 하나를 포기하고 싶지 않은 자리가 남아 있다는 뜻이다.
