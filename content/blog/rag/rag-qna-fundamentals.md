...
두 개선 모두 **토큰이 무엇인지 정해진 뒤에** 작동한다. 한국어에서 그 토큰을 정하는 것이 형태소 분석기이고, 사전에 무엇을 등록했느냐에 따라 같은 문장이 다르게 쪼개진다 — [한글 검색 구현](/blog/search-engineering/korean-text-search/)에서 다룬다.
