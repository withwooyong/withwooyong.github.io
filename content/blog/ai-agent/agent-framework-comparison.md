...
>
> 「추상화 수준·제어권 소재·1급 개념·흐름 형태·재개와 중단·LangChain 의존」 여섯 행은 LangGraph 공식 설명에 직접 근거가 있다. 「핵심 은유·개발 속도·디버깅 난이도·적합 상황」 네 행은 그 위에 얹은 해석이다.
>
> 구분이 필요한 자리는 이 표를 근거로 실제 선택을 할 때다. 공식 근거가 있는 행은 문서로 확인되지만, 해석 행은 팀의 숙련도와 운영 조건에 따라 달라진다.
