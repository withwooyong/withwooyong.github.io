...
| 편 | 다루는 것 | 이 편이 답하는 질문 |
| --- | --- | --- |
| [편2 — 제품 개발의 순환과 지표의 위계](/blog/product-management/product-cycle-and-metric-hierarchy/) | 개발의 네 단계, 지표 계층 구조, 역량의 세 영역, 사례 훈련법, 시장과 서비스를 고르는 틀 | 무엇을 위에 두어야 지표가 사슬이 되는가 |
| [편3 — 데이터가 필요한 이유와 지표 사전](/blog/product-management/why-data-and-metric-dictionary/) | 데이터의 쓸모, 정량과 정성의 구분, 퍼널 지표의 정의, 정성 데이터를 모으는 다섯 방법 | 그 값을 어떤 모수로 어떻게 세는가 |
| [편4 — 데이터 드리븐 한 바퀴](/blog/product-management/data-driven-project-walkthrough/) | 목표 수립부터 우선순위·요구사항 문서·지표 설정·성과 분석까지 하나의 사례로 관통 | 정한 대로 굴렸을 때 무엇이 남는가 |
| [편5 — 팀의 정의와 애자일 조직](/blog/product-management/team-building-and-agile-org/) | 팀과 팀 빌딩의 정의, 좋은 팀과 나쁜 팀의 갈림, 애자일 조직 | 팀을 최적화한다는 것은 무엇을 하는 일인가 |
| [편6 — 직책과 조직문화](/blog/product-management/roles-and-organizational-culture/) | 직무와 직급과 직책, 팀 빌딩에서의 역할, 국내 조직문화 세 유형의 비교 | 자기 자리를 어떻게 알아보는가 |
| [편7 — 글로벌 협업의 프로세스](/blog/product-management/global-collaboration-process/) | 채용 과정, 두 매니저 역할의 분담, 게이트 방식의 검토와 추진, 진행 관리 방안 | 경계를 좁게 긋는 것이 왜 빠른가 |
| [편8 — 글로벌 조직의 의사결정과 커뮤니케이션](/blog/product-management/global-decision-and-communication/) | 주간 공유, 의사결정의 구조, 커뮤니케이션 원칙, 사례, 자리 잡기 | 미리 꺼내 놓는 일이 왜 소통을 줄이는가 |
...
[다음 편](/blog/product-management/product-cycle-and-metric-hierarchy/)은 제품 개발의 순환과 지표의 위계를 다룬다 — 네 단계가 왜 순환인지, 지표를 계층으로 쌓는다는 것이 무엇인지, 그리고 지표 하나만 보고 성공이라 말했을 때 무엇을 놓치게 되는지다.
