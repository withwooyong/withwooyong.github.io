...
[지도편](/blog/product-management/pm-practice-map/)의 용어표가 이 편 몫으로 남겨 둔 것들 가운데 본문에 실제로 나온 것이다. 그 표가 여덟 편에 두루 통하는 뜻을 담았다면, 아래는 **이 편의 문맥에서 그 말이 무엇을 가리켰는지**를 적는다.
...
값을 세는 기준은 이렇게 정해진다. 그런데 실제 일은 지표를 정의하는 데서 시작하지 않는다. 목표를 세우고, 순서를 정하고, 무엇을 만들지 적어 넘기고, 결과를 다시 읽는 과정이 한 바퀴로 이어져야 한다. **[다음 편](/blog/product-management/data-driven-project-walkthrough/)은 그 한 바퀴를 하나의 사례로 끝까지 따라간다.**
