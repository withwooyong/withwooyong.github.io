...
모든 제품이 화면에서 시작하지도 않는다. 돈이 오가는 흐름을 다루는 곳에서는 계약과 거래와 현금을 순서대로 내려가고, 운영자가 쓰는 화면에서는 업무의 순서가 곧 데이터의 순서다. **[다음 편](/blog/product-management/commerce-member-and-catalog/)부터는 이 뼈대에 도메인의 살을 붙인다.**
