...
![AI 가 응답을 만들 때 참조하는 정보의 층 — 조직 전역 층(Enterprise 관리형 정책)에서 사용자 전역 층(~/.claude/CLAUDE.md), 프로젝트 층(프로젝트 루트 CLAUDE.md)으로 내려오고, 서브디렉토리 층 · 조건부 규정집 · 축적 기억의 세 갈래로 나뉜 뒤 세션 층(현재 대화 이력)으로 모여 AI의 응답이 된다](/images/blog/claude-md-information-layers-flow.svg "플로우차트")
...
![CLAUDE.md 작성법 3덩어리 × 7단계 — 덩어리1 정체성(1 프로젝트 개요 · 2 디렉토리 구조 · 3 기술 스택)에서 덩어리2 규칙(4 코딩 규칙 · 5 워크플로우 · 6 금지 사항 NEVER), 덩어리3 실용도구(7 커맨드 Cheatsheet) 순서로 나아간다](/images/blog/claude-md-three-chunks-flow.svg "플로우차트")
