...
const summaryCards = [
  ...
  },
  {
    ...
    title: "CMS 재구축·현대화",
    body: "차세대 CMS(NCMS) 재구축을 발주 PM으로 완주했고, 그 도메인의 1세대 TVING CMS를 파트 리드로 함께 설계 — 재구축과 원류를 모두 아는 리더.",
  },
  {
    Icon: ShoppingCart,
...
const journey = [
  ...
  },
  {
    ...
    roleDetail: "차세대 CMS(NCMS) 재구축의 발주 PM이자, B tv 미디어 플랫폼 백엔드를 리딩한 개발 매니저.",
  ...
  },
  {
    ...
    impact: "여러 디바이스로 일관되게 콘텐츠가 배급되는 코어 플랫폼을 팀과 함께 구축 — OTT CMS 도메인을 처음 다룬, 재구축 판단의 출발점.",
  },
  {
...
const capabilityMap: { need: string; evidence: string; confirm?: boolean }[] = [
  ...
  { need: "대규모 CMS 재구축·현대화", evidence: "SKB 차세대 CMS(NCMS) 재구축 발주 PM(MSA 설계·검토) + TVING CMS 1세대 구축 리드" },
...
export default function ProductLead() {
  const personJsonLd = {
    ...
    url: absoluteUrl("/product-lead-v2/"),
  ...
  return (
    <>
      <SiteHead
        ...
        description="20년간 OTT·커머스 플랫폼의 코어를 설계·재구축하고 20~30인 조직을 총괄해 온 리더. 차세대 CMS(NCMS) 재구축을 발주 PM으로 완주했고, OTT CMS 도메인을 1세대부터 이해합니다. CMS 재구축·플랫폼 거버넌스·AI 메타데이터 관점의 요약 한 장."
        path="/product-lead-v2/"
        jsonLd={personJsonLd}
      />
          ...
          <section className="flex flex-col sm:flex-row items-center gap-8">
            ...
            <div className="text-center sm:text-left">
              ...
              <p className="text-lg text-slate-600 dark:text-slate-300 mt-3 leading-relaxed">
                20년간 OTT·커머스 플랫폼의 코어를 설계·재구축하고, 20~30인 조직을 총괄해 온 리더.
              </p>
              <p className="text-base text-blue-700 dark:text-blue-300 font-medium mt-2">
                차세대 CMS 재구축을 발주 PM으로 완주하고, 커머스·AI 플랫폼까지 총괄하는 프로덕트 리더.
              </p>
            </div>
          </section>
          </SectionReveal>
