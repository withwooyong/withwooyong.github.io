...
│   └── blog/               # 목록 · 카테고리 · 글 · 태그
├── content/blog/           # 발행본 166편 + categories.ts · tags.ts
├── lib/
...
| 항목 | 규칙 |
|------|------|
| 카테고리 | [`content/blog/categories.ts`](content/blog/categories.ts)에 **12개 등록 · 6개 발행** (`ai-agent` 51 · `backend-engineering` 42 · `agentic-coding` 31 · `rag` 25 · `ai-transformation` 11 · `search-engineering` 6) |
