...
| --- | --- | --- |
| `content/blog/**.md` | 5단 — 금칙어 증명·불변식·금칙어 스캔·마크업 증명·마크업 스캔 | 좌동 + 빌드 산출물 스캔 · 개수 검사 |
| 그 밖의 `**.md` | 마크업 증명 → `--docs` 전량 스캔 (실측 1.9초) | 좌동 |
...
재현 절차와 실측값을 담은 전체 43건은 [`docs/TOOL-TRAPS.md`](docs/TOOL-TRAPS.md)(928줄)에 있다.
